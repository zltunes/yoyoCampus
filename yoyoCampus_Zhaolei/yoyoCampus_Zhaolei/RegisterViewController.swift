...
//        self.img.image = Consts.imageFromColor(Consts.tintGreen, size: self.img.frame.size)
        ...
        //注册
        self.registerBtn = Consts.setUpButton("注  册", frame: CGRect(x: 70 * Consts.ratio, y: newHeight * 0.8, width: newWidth - 140 * Consts.ratio, height: 86 * Consts.ratio), font: Consts.ft24, radius: 7)
