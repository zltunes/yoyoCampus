...
class campView: UIView {
    ...
    */
    override init(frame: CGRect) {
        ...
        let image1 = UIImageView(frame: CGRectMake(30, CGRectGetMaxY(nameLabel.frame)+10, self.frame.size.width*0.2,self.frame.size.height*0.3))
        ...
        let image4 = UIImageView(frame: CGRectMake(30, CGRectGetMaxY(image1.frame)+10, image1.frame.size.width, image1.frame.size.height))
        image4.image = UIImage(named: "camp_4")
        self.addSubview(image4)
        
        let image5 = UIImageView(frame: CGRectMake(CGRectGetMaxX(image4.frame)+30, image4.frame.origin.y, image4.frame.size.width, image4.frame.size.height))
        image5.image = UIImage(named: "camp_5")
        self.addSubview(image5)
        
        let image6 = UIImageView(frame: CGRectMake(CGRectGetMaxX(image5.frame)+30, image4.frame.origin.y, image4.frame.size.width, image4.frame.size.height))
        image6.image = UIImage(named: "camp_6")
        self.addSubview(image6)
        
        let image7 = UIImageView(frame: CGRectMake(windowWidth*0.93, 10, 7, 12))
